...
from nmoscommon.auth.nmos_auth import AuthMiddleware, get_auth_server_url, get_auth_server_metadata
...
class TestAuthMiddleware(unittest.TestCase):
    ...
    def testJWTClaimsValidator_x_nmos(self, mockGetJwk):
        ...
        # Middleware permits Read access due to x-nmos-connection token claims
